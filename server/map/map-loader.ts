...
export async function loadMap(filename: string) {
  const map: MapType = await new Promise((resolve, reject) => {
    tmx.parseFile(path.join(MAP_DIR, filename),
    function (err: any, loadedMap : any) {
